...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #Answer: It is because the shovel operator modifies also modifies the 
    #original string and plus equals operator unmodifies original string 
  end
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, a           == b
    assert_equal falsex , a.object_id == b.object_id
  end
end
